...
class DefaultComparator(SpatialComparator):
...
class DefaultPersistentSpatialElement(PersistentSpatialElement):
...
class DefaultSpatialDialect(SpatialDialect):
    ...
    def _get_function_mapping(self):
        return DefaultSpatialDialect.__functions
    
    def process_result(self, value, type):
        return DefaultPersistentSpatialElement(WKBSpatialElement(value, type.srid))
