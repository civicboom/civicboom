...
def secure_link(href, value='Submit', value_formatted=None, vals=[], css_class='', title=None, rel=None, confirm_text=None, method='POST', json_form_complete_actions='', modal_params=None):
    ...
    hf = HTML.span(
        ...
        end_form(),
        id='span_'+hhash, class_='secure_hide hide_if_nojs') # GregM: secure_hide means js will hide element and remove class (to stop dup processing of same element)
    ...
    hl = HTML.a(
        ...
        # style   = "display: none;",
        href    = href,
        class_  = css_class + ' secure_show hide_if_js', # GregM: secure_show means js will show element and remove class (to stop dup processing of same element)
        title   = title,
        rel     = rel,
