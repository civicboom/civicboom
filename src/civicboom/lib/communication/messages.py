...
generators = [
    ...
    ["assignment_accepted",                  "ne", _("_assignment accepted"),        _("%(reporter)s accepted your _assignment %(assignment)s")],
    ["assignment_interest_withdrawn",        "",   _("_assignment interest withdrawn"), _("%(reporter)s withdrew their interest in your _assignment %(assignment)s")],
    ["article_disasociated_from_assignment", "n",  _("_article dissasociated from _assignment"), _("%(reporter)s dissasociated your _article %(article)s from the _assignment %(assignment)s")],
    ...
    ["article_approved",                     "n",  _("_article approved by organisation"), _("%(reporter)s has approved your _article %(article)s in the response to their _assignment %(assignment)s. Check your email for more details")],
    ["boom_article",                         "ne", _("_article boom"),               _("%(reporter)s thinks you might find this _article interesting %(article)s")],
    ["boom_assignment",                      "ne", _("_assignment boom"),            _("%(reporter)s thinks you might want to add your opinion to this _assignment %(assignment)s")],
