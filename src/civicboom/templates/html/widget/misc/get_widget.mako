...
<%namespace name="get_widget" file="/html/frag/misc/get_widget.mako"/>
...
<form action="">
  <textarea name="widget_link" class="widget_link_form_field">${get_widget.widget_iframe(c.widget_owner)}</textarea>
</form>
