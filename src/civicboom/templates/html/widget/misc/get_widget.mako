...
% if c.widget['owner']['username']:
  <a href="${h.url(controller='misc', action='get_widget', id=c.widget['owner']['username'], sub_domain='www')}" target="_black">${_('Customise this widget')}</a>
% else:
  <a href="${h.url(controller='misc', action='get_widget',                                   sub_domain='www')}" target="_black">${_('Customise this widget')}</a>
% endif
