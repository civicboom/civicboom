...
<ul>
    ...
    <li>${_("Attribution - You must attribute the work in the manner specified by the author or licensor (but not in any way that suggests that they endorse you or your use of the work).")}</li>
</ul>
</p>
...
<p>
<b>${_("Q: What is a Hub?")}</b>
<br />${_("A: A Hub is a collection of registered users, unified under one \"identity\" - be it as an organisation, title or issue from which requests for _articles can be created for others to reposed to. All Hubs can create a bespoke _widget.")}
</p>

<p>
<b>${_("Q: What are the different roles in a Hub?")}</b>
<ul>
    <li>${_("Administrator: You have full privileges over the Hub; you can set member roles, create _article requests, invite and remove users from the Hub, publish and approve content, edit and delete _articles, and alter Hub settings.")}</li>
    <li>${_("Editor: You can publish and approve content, create _article requests and edit and delete _articles.")}</li>
    <li>${_("Contributor: You can create content and edit _articles.")}</li>
    <li>${_("Observer: You can view _articles and comment on them, but not create or publish them.")}</li>
</ul>
</p>
...
<br />${_("A: At the top right of every page there is a Login link, click here to sign up. Alternatively visit")} <a href="https://www.civicboom.com/account/signin">here</a>
</p>

<p>
<b>${_("Q: I've forgotten my password/username, what do I do?!")}</b>
<br />${_("A: Visit")} <a href="https://www.civicboom.com/account/signin">here</a> ${_(" and click on the \"forgotten your password\" button. You can then provide either your email address or username to recover your details.")}
</p>
...
<ol>
        ...
        <li>${_("You are responsible for all content posted and activity that occurs under your account (even when content is posted by others who have accounts under your account).")} </li>
        <li>${_("You may not use The Service for any illegal or unauthorised purpose. You must not, in the use of The Service, violate any laws in your jurisdiction (including but not limited to copyright laws). We may, but have no obligation to, remove content and accounts containing content that we determine in our sole discretion are unlawful, offensive, threatening, libellous, defamatory, pornographic, obscene or otherwise objectionable or violates any party's intellectual property or these Terms of The Service.")} </li>
</ol>
