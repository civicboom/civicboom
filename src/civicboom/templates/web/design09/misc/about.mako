...
<div class="misc_about misc_page_border">
  ...
  <div class="about_flow">
    ...
    <p class="step2"><span class="list_bullet_number">2</span><br/>Respond directly to ${app_globals.terminology['assignment']}s by uploading relevant news and insight</p>
    <ul class="stepB">
      <li>Participate directly in issues you care about</li>
      <li>Get recognised as a credible news source</li>
    </ul>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
      <div class="section_border">
        <h2>${app_globals.site_name} for the individual</h2>
        <ul>
        ...
        <h3>How?</h3>
        <p>${app_globals.site_name} works in 3 ways</p>
        <ol>
          <li>You can search ${app_globals.site_name} for call-to-action ${app_globals.terminology['assignment']}s from organisations and people that want your news, opinion and insight.</li>
          <li>You can respond to specific ${app_globals.terminology['assignment']}s for your news and insight wherever you see the ${app_globals.site_name} widget on other websites that want to news and insight from you.</li>
          <li>You can upload your news and insight directly, share with your Followers, and if appropriate even syndicate exclusive content that you have (photo's or video) and earn money.</li>
        </ol>
      </div>
    </div>
    ...
    <div class="yui-u">
      <div class="section_border">
        <h2>${app_globals.site_name} for organisations</h2>
        ...
        <h3>How?</h3>
        <p>${app_globals.site_name} works by enabling you to:</p>
        <ol>
          <li>Set a call-to-action ${app_globals.terminology['assignment']} for news or insight directly from your community via the widget powered by ${app_globals.site_name} as a public or "closed" ${app_globals.terminology['assignment']}.</li>
          <li>"Approve" relevant content for use in your publishing, news and research - plus if you are a media organisation, sell images or video on* (with share of revenue going back to the original creator).</li>
          <li>Establish a better connection and understanding of issues that matter to the community you serve.</li>
        </ol>
      </div>
    </div>
  ...
  <div class="yui-g">
    ...
    <div class="yui-u first">
      ...
      "package" on the organisation's Civicboom profile. The organisation is also able to sell on images or content, with part of the
      revenue shared with the contributor (automated through PayPal*).</p>
      
      
      <h2>What is a "closed" ${app_globals.terminology['assignment']}**?</h2>
      ...
      on the creators ${app_globals.site_name} profile but is also listed in the "responses" against the organisation's request, further building the
      ...
      content doesn't break our "4 Simple Rules", it can stay on ${app_globals.site_name} and can be used in any way by the creator.</p>
    ...
    <div class="yui-u">
      ...
      the content you have uploaded via Civicboom, you need a profile. It also means that other users of Civicboom can find and
      ...
      <p>By using ${app_globals.site_name}, media organisations may want to sell on your original content (images and video) with a share of the
      ...
      <p>Civicboom takes copyright very seriously. As a user, you are responsible for ensuring you have the adequate copyright
