...
<p >${_('The assigner will be able to use this content under the %(cc_link)s Creative Commons Attribution 3.0 Unported %(cc_link_end)') % {cc_link:'<a href="http://creativecommons.org/licenses/by/3.0/">', cc_link_end:'</a>'} }</p>
