...
<br />
<p style="font-size: 120%">Get started now! <a style="font-weight: bold" href="${h.url('contents', list='assignments_active', protocol='https', sub_domain='www', qualified=True)}">CLICK HERE FOR LATEST REQUESTS</a></p>
<br />
...
<p style="font-size: 120%; font-weight: bold">Got Android? <a href="${h.url(controller='about', action='mobile', protocol='https', sub_domain='www', qualified=True)}">Grab the app HERE!</a></p>
<br />
