...
<h1>${registered_user.name or registered_user.username} - welcome to <a href="${h.url('', absolute=True)}">${_('_site_name')}!</a></h1>
<br />
...
<br />
<p style="font-size: 120%">Get started now! <a style="font-weight: bold" href="${h.url('contents', list='assignments_active', absolute=True)}">CLICK HERE FOR LATEST REQUESTS</a></p>
<br />
...
<p style="font-size: 120%; font-weight: bold">Got Android? <a href="${h.url(controller='about', action='mobile', absolute=True)}">Grab the app HERE!</a></p>
<br />
