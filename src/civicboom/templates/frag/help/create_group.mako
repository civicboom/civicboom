...
<p>${_("By creating a _group, you also create a widget associated with it. The widget holds a list of all your requests and can be embedded on a specific page or website empowering your community to respond directly to requests set by that _group.")}</p>
