      ...
      <div class="frag_col">
        ...
        % if 'accepted_status' in d:
            ...
            ${frag_lists.member_list_thumbnails(
                ...
                actions = h.frag_link('Invite Members', class_='icon icon_invite', href_tuple=h.args_to_tuple(controller='invite', action='index', id=self.id, invite='assignment')) if 'invite_to_assignment' in self.actions else None ,
            )}
            ${frag_lists.member_list_thumbnails(
