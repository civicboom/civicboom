...
#    map.connect('/settings/{panel}/{id}.{format}', controller='settings', action="show", conditions=dict(method=['GET']))
#    map.connect('/settings/{panel}/{id}', controller='settings', action="show", conditions=dict(method=['GET']))
#    map.connect('/settings/{panel}.{format}', id=None, controller='settings', action="show", conditions=dict(method=['GET']))
#    map.connect('/settings/{panel}', id=None, controller='settings', action="show", conditions=dict(method=['GET']))
    #map.connect('/settings/{action}/{id}.{format}', controller='settings')
    #map.connect('/settings/{action}/{id}', controller='settings')
